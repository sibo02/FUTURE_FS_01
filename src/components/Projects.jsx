            ...
            <div className="project-grid">
                       ...
                       <div className="project-card">
                        <h3>Advice Generator App</h3>
                         <p>A web application that allows users to generate random advice.</p>
                             ...
                             <a 
                               href="https://github.com/sibo02/advice-generator" 
                               target="_blank"
                               rel="noreferrer"
                             >
                              View on GitHub
                             ...
                             <a
                              href="https://sibo02.github.io/advice-generator" 
                              target="_blank"
                              rel="noreferrer"
                              >
                                Live Demo
                    ...
                    <div className="project-card">
                        ...
                        <p>A simple game where players can play rock, paper, scissors against the computer.</p>
                          <div className="project-links">
                            <a 
                            href="https://github.com/sibo02/rock-paper-scissors" 
                            target="_blank"
                            rel="noreferrer"
                            >
                              View on GitHub
                            ...
                            <a 
                            href="https://sibo02.github.io/rock-paper-scissors" 
                            target="_blank"
                            rel="noreferrer"
                            >
                              Live Demo 
                    ...
                    <div className="project-card">
                        <h3>Intro Component With Sign Up Form</h3>
                         <p>A responsive intro component with a sign-up form.</p>
                            <div className="project-links">
                             <a
                              href="https://github.com/sibo02/intro-component" 
                              target="_blank"
                              rel="noreferrer"
                              >
                                View on GitHub
                             ...
                             <a 
                              href="https://sibo02.github.io/intro-component" 
                              target="_blank"
                              rel="noreferrer"
                             >
                              Live Demo
